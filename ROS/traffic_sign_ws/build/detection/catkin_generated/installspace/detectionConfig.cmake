...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/traffic_sign_ws/install/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/traffic_sign_ws/install/lib;/root/traffic_sign_ws/devel/lib;/root/catkin_ws/devel/lib;/opt/ros/indigo/lib)
