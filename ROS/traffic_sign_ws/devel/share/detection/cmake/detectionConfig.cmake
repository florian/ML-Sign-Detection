...
if("TRUE" STREQUAL "TRUE")
  set(detection_SOURCE_PREFIX /home/dorian/traffic_sign_ws/src/detection)
  set(detection_DEVEL_PREFIX /home/dorian/traffic_sign_ws/devel)
  ...
  set(detection_INSTALL_PREFIX /home/dorian/traffic_sign_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dorian <dorian@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dorian/traffic_sign_ws/src/detection/${idir}'.  Ask the maintainer 'dorian <dorian@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dorian/traffic_sign_ws/devel/lib;/opt/ros/indigo/lib)
